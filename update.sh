...
download_tool \
  "mojom compiler" \
  "tools/bindings/mojom_tool/bin/${HOST_PLATFORM}/mojom" \
  "mojo/mojom_parser/${HOST_PLATFORM}"

download_tool \
  "mojom c generator" \
  "tools/bindings/mojom_tool/bin/${HOST_PLATFORM}/generators/c" \
  "mojo/mojom_parser/${HOST_PLATFORM}/generators"

download_tool \
  "mojom go generator" \
  "tools/bindings/mojom_tool/bin/${HOST_PLATFORM}/generators/go" \
  "mojo/mojom_parser/${HOST_PLATFORM}/generators"

download_tool \
  "mojom deps generator" \
  "tools/bindings/mojom_tool/bin/${HOST_PLATFORM}/generators/deps" \
  "mojo/mojom_parser/${HOST_PLATFORM}/generators"
