...
#[repr(u32)]
pub enum MojoResult {
    // TODO(vtl): Rename Cancelled, etc. to SystemCancelled?
    Okay = 0x0,
    Cancelled = 0x1,
    Unknown = 0x2,
    InvalidArgument = 0x3,
...
impl MojoResult {
    ...
    pub fn from_code(code: MojoResultCode) -> MojoResult {
        match code as u32 {
            ...
            0x0013 => MojoResult::BadHandle,
            0x0023 => MojoResult::WrongType,
    ...
    pub fn to_str(&self) -> &'static str {
        match *self {
            ...
            MojoResult::BadHandle => "Bad Handle",
            MojoResult::WrongType => "Wrong Type",
