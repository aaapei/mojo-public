...
# MojoResult (see mojo/public/c/include/mojo/result.h and
# .../mojo/system/result.h).
RESULT_OK = c_core.MOJO_RESULT_OK
SYSTEM_RESULT_CANCELLED = c_core.MOJO_SYSTEM_RESULT_CANCELLED
SYSTEM_RESULT_UNKNOWN = c_core.MOJO_SYSTEM_RESULT_UNKNOWN
SYSTEM_RESULT_INVALID_ARGUMENT = c_core.MOJO_SYSTEM_RESULT_INVALID_ARGUMENT
SYSTEM_RESULT_BAD_HANDLE = c_core.MOJO_SYSTEM_RESULT_BAD_HANDLE
SYSTEM_RESULT_WRONG_TYPE = c_core.MOJO_SYSTEM_RESULT_WRONG_TYPE
SYSTEM_RESULT_DEADLINE_EXCEEDED = c_core.MOJO_SYSTEM_RESULT_DEADLINE_EXCEEDED
SYSTEM_RESULT_NOT_FOUND = c_core.MOJO_SYSTEM_RESULT_NOT_FOUND
SYSTEM_RESULT_ALREADY_EXISTS = c_core.MOJO_SYSTEM_RESULT_ALREADY_EXISTS
SYSTEM_RESULT_PERMISSION_DENIED = c_core.MOJO_SYSTEM_RESULT_PERMISSION_DENIED
SYSTEM_RESULT_RESOURCE_EXHAUSTED = c_core.MOJO_SYSTEM_RESULT_RESOURCE_EXHAUSTED
SYSTEM_RESULT_FAILED_PRECONDITION = \
    c_core.MOJO_SYSTEM_RESULT_FAILED_PRECONDITION
SYSTEM_RESULT_BUSY = c_core.MOJO_SYSTEM_RESULT_BUSY
SYSTEM_RESULT_ABORTED = c_core.MOJO_SYSTEM_RESULT_ABORTED
SYSTEM_RESULT_OUT_OF_RANGE = c_core.MOJO_SYSTEM_RESULT_OUT_OF_RANGE
SYSTEM_RESULT_UNIMPLEMENTED = c_core.MOJO_SYSTEM_RESULT_UNIMPLEMENTED
SYSTEM_RESULT_INTERNAL = c_core.MOJO_SYSTEM_RESULT_INTERNAL
SYSTEM_RESULT_UNAVAILABLE = c_core.MOJO_SYSTEM_RESULT_UNAVAILABLE
SYSTEM_RESULT_SHOULD_WAIT = c_core.MOJO_SYSTEM_RESULT_SHOULD_WAIT
SYSTEM_RESULT_DATA_LOSS = c_core.MOJO_SYSTEM_RESULT_DATA_LOSS
...
cdef class Handle(object):
  ...
  def ReadMessage(self,
    ...
    cdef res = c_core.MojoReadMessage(self._mojo_handle,
                                      ...
                                      &input_handles_length,
                                      flags)
    if res == c_core.MOJO_SYSTEM_RESULT_RESOURCE_EXHAUSTED:
